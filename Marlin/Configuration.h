...
#define STRING_CONFIG_H_AUTHOR "(@AndersSahlman)" // Who made the changes.
...
/**
 * Select the serial ports on the board to use for communication with the host.
...
// Name displayed in the LCD "Ready" message and Info menu
  ...
  #endif
  #ifdef Q5_2208
    #define CUSTOM_MACHINE_NAME "FLSUN Q5 2208"
  #endif
 ...
 */
#if ENABLED(QQS_SKR_2209)
  #define DRIVER_USED TMC2209 
#endif
#if EITHER(QQS, Q5)
...
#define LIMITED_MAX_ACCEL_EDITING     // Limit edit via M201 or LCD to DEFAULT_MAX_ACCELERATION * 2
  ...
  #define MAX_ACCEL_EDIT_VALUES       { 10000, 10000, 10000, 20000 } // ...or, set your own edit limits
#endif
