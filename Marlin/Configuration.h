...
#define CUSTOM_MACHINE_NAME "FLSUN QQ-S skr 1.3"
...
#define DELTA
  ...
  #define DELTA_HEIGHT 366.89             // (mm) Get this value from G33 auto calibrate

  #define DELTA_ENDSTOP_ADJ { -2.21, 0.0, -2.82 } // Get these values from G33 auto calibrate

  // Horizontal distance bridged by diagonal push rods when effector is centered.
  #define DELTA_RADIUS 143.65              // (mm) Get this value from G33 auto calibrate

  // Trim adjustments for individual towers
  // tower angle corrections for X and Y tower / rotate XYZ so Z tower angle = 0
  // measured in degrees anticlockwise looking from above the printer
  #define DELTA_TOWER_ANGLE_TRIM { -0.25, 0.32, -0.08 } // Get these values from G33 auto calibrate
 ...
 */
#define NOZZLE_TO_PROBE_OFFSET { 0, 0, -9.2 }
